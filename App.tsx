            ...
            <main>
                ...
                <div className={`${gameMode === 'BLACK' ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-md p-4 mt-6`}>
                    ...
                    <div className="flex space-x-2 mb-4">
                        <button onClick={() => addRecord('top')} className={`flex-1 ${gameMode === 'BLACK' ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-800'} font-semibold py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center space-x-2`}>
                           <PlusIcon className="w-5 h-5" /> <span>上に行追加</span>
                        </button>
                    ...
                    <div className="flex space-x-2 mt-4">
                        <button onClick={() => addRecord('bottom')} className={`flex-1 ${gameMode === 'BLACK' ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-200 hover:bg-gray-300 text-gray-800'} font-semibold py-2 px-4 rounded-lg transition duration-200 flex items-center justify-center space-x-2`}>
                            <PlusIcon className="w-5 h-5" /> <span>下に行追加</span>
                        </button>
                        <button 
